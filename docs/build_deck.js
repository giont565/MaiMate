...
(async () => {
  ...
  // ============ S12 商業：怎麼賺錢 ============
  {
    ...
    s.addNotes("＜商業性 20%＞評審是交易所的人——先講①手續費語言最直接（此資料集帳戶年 4,674 筆，流失一個平台年損上萬到數十萬手續費），再用③④展示想像空間。費率已查證：基礎掛單 0.08%/吃單 0.16%，MAX Token 折抵 -30%（以官網現時公告為準）。「只有交易所做得出來」：行為數據只有交易所有，外部工具拿不到。");
  }
